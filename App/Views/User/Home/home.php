                        ...
                        <div class="span6">
                            <div class="carousel-caption">
                                ...
                                <p class="lead">Chúng tôi cung cấp cho các bạn những kiến
                                    thức tốt nhất.</p>
                                    <?php
                                      // Giả sử bạn có một hàm kiểm tra xem người dùng đã đăng nhập hay chưa
                                      function isLoggedIn() {
                                ...
                                <a class="btn btn-large btn-primary openModalFunction" href="<?= base_url('User/Register') ?> "style="display:<?php echo $display; ?>;"  id="modal1">Tham gia</a>


                                <a class="btn btn-large btn-primary openModalFunction" href="<?= base_url('User/Login') ?>" id="modal1">Xem ngay</a>
                    ...
                    <div class="row">
                        <div class="span6">
                            <div class="carousel-caption">
                                ...
                                <p class="lead">Chúng tôi cung cấp cho các bạn những kiến
                                    thức tốt nhất.</p>
                                <a class="btn btn-large btn-primary openModalFunction" style="display: none;" id="modal2">Tham gia</a>
                                <a class="btn btn-large btn-primary doExam " style="display: none;">Tham gia</a>
